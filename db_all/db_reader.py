    ...
    try:
        ...
        for _ in range(3):
            ...
            try:
                ...
                print("REader connection established hotels")
                break
            except Error as e:
        ...
        try:
            select_query  = ("SELECT id, hotel_id, url, fotos, description, room, facility FROM upz_hotels "
        ...
        try:
            for id, hotel_id, url, fotos, description, room, facility in hotels_data:
                data_DB.append({
                    'id': id,
                    'hotel_id': hotel_id,
                    'url': url,
...
# # p2 = int(last_item) - n1
# # p1 = int(last_item) - n2
# p2 = int(last_item) - 100
# p1 = int(last_item) - 150
# # n1 = n2 - 50
# # n1, n2 = 0, 2
# print(n1, n2)
